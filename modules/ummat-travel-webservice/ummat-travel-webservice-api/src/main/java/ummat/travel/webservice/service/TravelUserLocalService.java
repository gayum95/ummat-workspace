...
/**
 * Provides the local service interface for TravelUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TravelUserLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TravelUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>ummat.travel.webservice.service.impl.TravelUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the travel user local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TravelUserLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TravelUser addTravelUser(TravelUser travelUser);
	...
	public TravelUser createTravelUser(long travelUserId);
	...
	public TravelUser deleteTravelUser(long travelUserId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TravelUser deleteTravelUser(TravelUser travelUser);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TravelUser fetchTravelUser(long travelUserId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TravelUser fetchTravelUserByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TravelUser getTravelUser(long travelUserId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TravelUser getTravelUserByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TravelUser> getTravelUsers(int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TravelUser getTravelUsers(long userId, long companyId);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TravelUser updateTravelUser(TravelUser travelUser);
